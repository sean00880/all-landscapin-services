  ...
  return (
    <div className={style.container}>
      <div className={style.info}>
        ...
        <h4 className={style.text}><hr/>All Landscaping Services, LLC was founded by David Elmer Cruz in 2017. Over the last 5 years, we have provided professional landscaping services to hundreds of commercial and resicential clients in the state of Maryland. </h4>
